...
const Navbar: React.FC<NavbarProps> = ({ sidebarCollapsed = false }) => {
  ...
  return (
    <>
      {/* 侧边栏占位空间 - 与侧边栏宽度相同 */}
      <div 
        className={`fixed top-0 left-0 h-14 bg-white dark:bg-dark-primary border-b border-neutral-200 dark:border-zinc-800 transition-all duration-300 z-50 ${
      ...
      {/* 导航栏主体 */}
      <nav 
        className={`fixed top-0 right-0 h-14 bg-white dark:bg-dark-primary border-b border-neutral-200 dark:border-zinc-800 transition-all duration-300 z-50 ${
