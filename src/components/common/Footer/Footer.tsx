    ...
    <footer className="bg-white dark:bg-dark-primary text-neutral-500 dark:text-neutral-400 border-t border-neutral-200 dark:border-zinc-800 py-8 mt-10">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="font-semibold text-lg text-neutral-800 dark:text-white mb-4">关于我们</h3>
            <p className="mb-4">这是一个使用Next.js、Element Plus和Tailwind CSS构建的论坛网站。</p>
          ...
          <div>
            <h3 className="font-semibold text-lg text-neutral-800 dark:text-white mb-4">快速链接</h3>
            <ul className="space-y-2">
              <li><Link href="/" className="hover:text-primary">首页</Link></li>
              <li><Link href="/popular" className="hover:text-primary">热门</Link></li>
              <li><Link href="/category/tech" className="hover:text-primary">技术</Link></li>
              <li><Link href="/category/entertainment" className="hover:text-primary">娱乐</Link></li>
            </ul>
          </div>
          
          <div>
            <h3 className="font-semibold text-lg text-neutral-800 dark:text-white mb-4">联系我们</h3>
            ...
            <div className="relative h-12 mb-4">
              {teamMembers.map((member, index) => (
                <div 
                  key={member.id}
                  className="absolute rounded-full border-2 border-white dark:border-zinc-800 group cursor-pointer"
                  style={{ 
                    width: '40px', 
                    height: '40px', 
                    left: `${index * 20}px`,
