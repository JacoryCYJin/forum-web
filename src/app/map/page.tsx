    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex-grow relative">
        ...
        <div className="absolute top-10 left-1/2 transform -translate-x-1/2 z-10 text-center">
          <h1 className="text-4xl font-bold text-white shadow-text mb-2">地理社区</h1>
          <p className="text-xl text-white shadow-text max-w-lg">
            基于地理位置的实时社区平台，在地图上发现身边的话题
          </p>
        </div>
        ...
        <div className="absolute right-10 top-1/2 transform -translate-y-1/2 z-10 bg-white dark:bg-dark-secondary bg-opacity-90 dark:bg-opacity-90 p-6 rounded-lg shadow-lg max-w-xs">
          <h2 className="text-2xl font-bold text-neutral-800 dark:text-white mb-4">平台特色</h2>
          <ul className="space-y-3">
            <li className="flex items-start">
              ...
              <span className="text-neutral-700 dark:text-neutral-200">实时地理位置发帖，帖子在地图上显示</span>
            </li>
            <li className="flex items-start">
              <div className="bg-primary rounded-full p-1 mr-2 mt-1">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <span className="text-neutral-700 dark:text-neutral-200">帖子气泡随时间逐渐淡化，30分钟后消失</span>
            </li>
            <li className="flex items-start">
              <div className="bg-primary rounded-full p-1 mr-2 mt-1">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <span className="text-neutral-700 dark:text-neutral-200">发现身边的热门话题和有趣内容</span>
            </li>
            <li className="flex items-start">
              <div className="bg-primary rounded-full p-1 mr-2 mt-1">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <span className="text-neutral-700 dark:text-neutral-200">基于位置的社交互动和信息分享</span>
            </li>
          </ul>
        </div>
      </div>
